...
function importerMain() {
    ...
    ig.game.settings.Create.addendum("Warning: This modification is seen by some as unfair and in violation of Saltfree TOS, use at your own discretion. (U can get ur account banned buddy :3)", 'red');
